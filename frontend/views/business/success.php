...
<div class="businesses-view container">
    ...
    <h3>Dear <?php echo $contact->giveName; ?>, </h3>
    <p style="font-size: 20px">You have successfully registered <b><?php echo $model->name ?> </b> on <b class='h mykazi_red'>My Kazi</b>. To view jobs that have been posted, please log in
